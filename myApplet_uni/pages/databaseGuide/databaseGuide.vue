<template>
    ...
    <view class="container">
        ...
        <view class="list">
            ...
            <view class="list-item">
                <text class="request-text" :style="'color: ' + (step === index + 1 ? 'red' : 'black')" v-for="(item, index) in 7" :key="index">{{ index + 1 }}</text>
            </view>
        ...
        <view class="guide" v-if="step === 2">
            ...
            <image class="flat-image" src="/static/images/create-collection.png" mode="aspectFit"></image>
        ...
        <view class="guide" v-if="step === 3">
            ...
            <image class="code-image" src="/static/images/code-db-onAdd.png" mode="aspectFit"></image>
        ...
        <view class="guide" v-if="step === 4">
            ...
            <image class="code-image" src="/static/images/code-db-onQuery.png" mode="aspectFit"></image>
        ...
        <view class="guide" v-if="step === 5">
            ...
            <text class="p">2. 把注释掉的代码解除注释</text>
            <image class="code-image" src="/static/images/code-db-inc-dec.png" mode="aspectFit"></image>
        ...
        <view class="guide" v-if="step === 6">
            ...
            <text class="p">2. 把注释掉的代码解除注释</text>
            <image class="code-image" src="/static/images/code-db-onRemove.png" mode="aspectFit"></image>
